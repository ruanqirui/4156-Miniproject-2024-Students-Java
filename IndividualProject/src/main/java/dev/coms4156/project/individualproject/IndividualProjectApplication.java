...
public class IndividualProjectApplication implements CommandLineRunner {
  ...
  */
  public void run(String[] args) {
    for (String arg : args) {
      if ("setup".equals(arg)) { //fixed arg.equals("setup")
  ...
  */
  public void resetDataFile() {
    ...
    Map<String, Course> courses = new HashMap<>(); //fixed
    ...
    Map<String, Department> mapping = new HashMap<>(); //fixed
  ...
  /**
  * This handles the termination logic, 
  * ensuring that cantents are saved to the file system before the termination. 
  *
  * @PreDestroy to call prior to the destruction phase.
  */
  @PreDestroy
